...
def fun(dirctry,fname):
    ...
    b=open("/Users/adityakhetarpal/Downloads/textpool/webapp/index_general.html","r")
    ft=b.read()
    #print ft
    b.close()
    a=open("/Users/adityakhetarpal/Downloads/textpool/webapp/index_general.html","w")
    ind=ft.find("<tbody>")+8
    ind2=ft.find("</tbody>")
    a.write(ft[:ind2])
    for h in htmls:
