...
tab={}
resnames=[]
fd=open("/Users/adityakhetarpal/Downloads/textpool/webapp/restaurant/food.txt")
#global food
food=fd.read().decode('latin-1')
#ambience=newcorpus.open("ambience.txt").read().encode('utf-8')
am=open("/Users/adityakhetarpal/Downloads/textpool/webapp/restaurant/ambience.txt")
#global ambience
ambience=am.read().decode('latin-1')
sr=open("/Users/adityakhetarpal/Downloads/textpool/webapp/restaurant/service.txt")
#global ambience
...
##    a.close()
##    
    b=open("/Users/adityakhetarpal/Downloads/textpool/webapp/index.html","r")
    ft=b.read()
    #print ft
    b.close()
    a=open("/Users/adityakhetarpal/Downloads/textpool/webapp/index.html","w")
    ind=ft.find("<tbody>")+8
    ind2=ft.find("</tbody>")
    a.write(ft[:ind2])
    for h in htmls:
